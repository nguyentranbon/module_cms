...
$list_module = ["1", "2", "45", "40", "5", "15", "6", "7", "23", "8", "9", "27"];
?>
<!DOCTYPE html>
...
<body <?php body_class(); ?>>
    ...
    include get_template_directory() . '/module_cms/45/45-content.php';
    ?>
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-xl-9 col-md-9">
                <?php include get_template_directory() . '/module_cms/40/40-content.php'; ?>
            </div>
