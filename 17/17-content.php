...
<div class="type-17">
    <div class="account">
        <div class="container">
            <div class="flex-wrap">
                <div class="flex-left">
                    <a href="#" class="logo">
                        <img src="http://<?php echo $url_path ?>/images/hinh17.png" alt="hinh17" width="252" height="50">
                    </a>
                </div>
                <div class="flex-right">
                    <a href="#"><img src="http://<?php echo $url_path ?>/images/hinh17-2.png" alt="hinh17-2" width="728" height="90"></a>
                </div>
            </div>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg navbar-light no-response">
        ...
        <a class="navbar-brand" href="#"><img src="http://<?php echo $url_path ?>/images/hinh17.png" alt="hinh17"></a>
